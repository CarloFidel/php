...
class Usuario {
    ...
    public function create() {
        ...
        $query = "INSERT INTO " . $this->table_name . " (id, nombre, usuario, email, password, tipo_usuario, foto) 
                 VALUES (:id, :nombre, :usuario, :email, :password, :tipo_usuario, :foto)";
        ...
        return ["error" => "Error al cargar el usuario"];
    } catch (PDOException $e) {
     if ($e->getCode() == 23000) { //Error de duplicado
       return ["error" => "El email ya está regitrado"]; 
     }
