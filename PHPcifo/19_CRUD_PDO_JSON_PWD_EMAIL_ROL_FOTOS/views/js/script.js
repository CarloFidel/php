...
const inicializarEventos = () => {
  ...
  btnBorrar.addEventListener("cick", () => {
    nombre.value = "";
    usuario.value = "";
    email.value = "";
    password.value = "";
...
// Mostrar los datos en la tabla  &#1F4F7;
const mostrarDatos = (datos) => {
  ...
  datos.forEach((dato) => {
    ...
    fila.innerHTML = `
            ...
            <td>
             <div class="user-photo-container">
              <img src="${
                dato.foto || "views/img/default_user.svg"
              }" alt="Foto de ${dato.nombre}"
            class="user-photo" onerror="this.src='views/img/default_user.svg'">
    ...
    //Capturar la edición de la foto del usuario llamando a su funcion
...
// Funcion para cambiar foto de un usuario
const cambiaFoto = (id) => {
  ...
  input.onchange = async (e) => {
    ...
    if (file) {
      ...
      try {
        ...
        if (resultado.error) {
          mostrarMensaje(resultado.erro, true);
        } else {
